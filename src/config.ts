...
export const config = {
  ...
  discord_empty_wallet_gifs: [
    'https://media.tenor.com/J3mNIbj6A4wAAAAd/empty-shelves-john-travolta.gif',
    'https://media.tenor.com/NteLNqDJB2QAAAAd/out-of-stock-this-is-happening.gif',
  ],
  //
  ...
  discord_owned_tokens_image_path:
    'http://70.34.216.182/token_images/phunk<tokenId>.png',
  ...
  saleMessage:
    '🚨 Emblem Vault #<tokenId> was sold for 💰 <ethPrice> (<fiatPrice>)\n\nfrom: <from>\nto: <to>\n\nhttps://etherscan.io/tx/<txHash>\nhttps://opensea.io/assets/0x7E6027a6A84fC1F6Db6782c523EFe62c923e46ff/<tokenId>\nhttps://looksrare.org/collections/0x7E6027a6A84fC1F6Db6782c523EFe62c923e46ff/<tokenId>\n',
